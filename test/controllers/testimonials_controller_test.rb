...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference("Testimonial.count") do
      post testimonials_url, params: { testimonial: { content: @testimonial.content, name: @testimonial.name, product_line_id: @testimonial.product_line_id, website: @testimonial.website } }
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { content: @testimonial.content, name: @testimonial.name, product_line_id: @testimonial.product_line_id, website: @testimonial.website } }
