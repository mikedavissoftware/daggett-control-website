...
class ProductLinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_line" do
    assert_difference("ProductLine.count") do
      post product_lines_url, params: { product_line: { company: @product_line.company, description: @product_line.description, logo: @product_line.logo, website: @product_line.website } }
    end
  ...
  test "should update product_line" do
    patch product_line_url(@product_line), params: { product_line: { company: @product_line.company, description: @product_line.description, logo: @product_line.logo, website: @product_line.website } }
