...
export default function HomePage() {
  ...
  return (
    <div>
      <h3 className="text-xl my-2"><strong>A little bit about us...</strong></h3>
      ...
      <h3 className="text-xl my-2"><strong>Other general information about the company:</strong></h3>
    </div>
  )
}