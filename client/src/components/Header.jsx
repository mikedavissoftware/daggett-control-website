...
export default function Header() {
  ...
  return (
    <header className="p-5 bg-slate-600 text-base-content">
      ...
      <div>
        <h1 className="text-3xl font-bold mb-2 md:text-4xl text-accent drop-shadow-lg">Daggett Control Company, LLC</h1>
        <h3 className="text-lg font-semibold mb-6 drop-shadow-md">Industrial Controls & Consulting</h3>
      </div>
